...
- **parameters.f90** (module $\color{teal}\texttt{MOD\\_Parameters}$): The purpose of this module is to read the input file, define parameters and set the pointers depending on the flags given at the input file. Here there is a list with some of the models and functions implemented and under development:
